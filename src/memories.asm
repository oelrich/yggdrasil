...
check_block:
  ld a0, s2 # Load metadata.
  call load_metadata # Get use and size for the address.
  bnez a0, skip_to_next # Block is in use, skip.
  beq a1, zero, do_allocate_new
  blt a1, s1, skip_to_next # Block is too small, skip.
  mv a0, s2 # The address we landed on.
  call allocate_existing
  j done
do_allocate_new:
  mv a0, s2
  mv a1, s1
